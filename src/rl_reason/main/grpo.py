...
from rl_reason.reward_functions import create_reward_functions
...
class ScriptArguments:
    ...
    def __post_init__(self):
        if not self.reward_config:
            raise ValueError('reward_config must be set!')
...
def grpo_function(
    ...
    reward_funcs = create_reward_functions(script_args.reward_config)
    ...
    if last_checkpoint is not None:
        if training_args.resume_from_checkpoint:
            ...
            raise ValueError('checkpoint detected but resume_from_checkpoint is not set')
